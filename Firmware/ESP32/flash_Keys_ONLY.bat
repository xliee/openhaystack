@echo off
@REM flash_Keys_ONLY.bat COM6 "C4XtRo98PhhzO9V/jwwIPprCjxk3mSn+O+gRIG7unWc=" "BBX8cYk9jDdMRRuty8kTyJHelSPhYAfgGDMI4Kb88Nl9PTshm7nBZY1/FowHEHJ6b61Y7HkXhSdh"
...
esptool.py --after no_reset -p %PORT% erase_region 0xe000 0x2000
